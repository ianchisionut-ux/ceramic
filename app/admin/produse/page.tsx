    ...
    <main style={{ padding: "2rem" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem" }}>
        ...
        <Link
          ...
          style={{ padding: "8px 14px", background: "var(--color-primary)", color: "white", borderRadius: "6px", textDecoration: "none", fontSize: "13px" }}
        >
          Adauga produs
        </Link>
      </div>
            ...
            return (
              <tr key={p.id} style={{ borderBottom: "1px solid var(--color-border)" }}>
                ...
                <td style={{ padding: "8px" }}>
                  <Link href={`/admin/produse/${p.id}`} style={{ color: "var(--color-primary)" }}>
                    Editeaza
                  </Link>
                </td>
              </tr>
